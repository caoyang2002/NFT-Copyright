...
function App() {
	...
	function displayCard(
		...
		// nft 的 url
		const nftUrlElement = document.createElement("a");
			...
			initialData: [
				// from aptos move
				{
					...
					data: {
						...
						deposit_amount: "Security deposit: 10.000",
						selling_price: "prince: 1.000",
						create_time: "12:30:44",
						validity_period: "validity period: 6000 m",
